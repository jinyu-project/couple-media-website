    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">管理您的文档</p>
        </div>
      ...
      {showUpload && (
        <div className="space-y-4">
          ...
          <FileUpload fileType="document" onUploadSuccess={handleUploadSuccess} />
        </div>
      )}

      <div>
        <h2 className="text-xl font-semibold mb-4">所有文档</h2>
        <FileList
          key={refreshKey}
          fileType="document"
